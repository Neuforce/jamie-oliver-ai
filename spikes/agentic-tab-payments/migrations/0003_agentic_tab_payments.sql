-- Agentic Tab Payments spike — additive tables.
-- Applied to the Supabase project (ktprgvcdemkfcdsosdur) via the Supabase MCP as
-- migration `0003_agentic_tab_payments_spike`. Recorded here for reproducibility.
-- Promote to a proper Prisma migration in packages/database when productionizing.
